...
* **feature-accounts**
    ...
    * 🆕 The `fxaccounts:fxa_status` WebChannel response now advertises `signedInUser.hasSyncKeys`, telling FxA whether the signed-in account has been granted the Sync scope and so holds the Sync key.
